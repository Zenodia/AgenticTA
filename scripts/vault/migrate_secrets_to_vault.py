...
def migrate_secrets(dry_run: bool = False):
    ...
    if dry_run:
        ...
        logger.info("   # or: python scripts/vault/vault_health_check.py")
        logger.info("")
        logger.info("2. Test application with Vault:")
        logger.info("   python scripts/vault/test_vault_integration.py")
        logger.info("")
